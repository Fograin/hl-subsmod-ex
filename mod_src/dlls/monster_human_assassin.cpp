...
void CHAssassin :: Spawn()
{
	...
	SET_MODEL(ENT(pev), "models/npcs/human_assassin.mdl");
...
{
	PRECACHE_MODEL("models/npcs/human_assassin.mdl");
	...
	m_iShell = PRECACHE_MODEL ("models/weapons/shell_pistol.mdl");// brass shell
}	

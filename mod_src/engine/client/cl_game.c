...
=========
*/
HSPRITE_ pfnSPR_LoadExt( const char *szPicName, uint texFlags )
{
	char	name[64];
	int	i;
...
=============
*/
const model_t *CL_GetSpritePointer( HSPRITE_ hSprite )
{
...
=========
*/
static int pfnSPR_Frames( HSPRITE_ hPic )
{
	int	numFrames;
...
=========
*/
static int pfnSPR_Height( HSPRITE_ hPic, int frame )
{
	int	sprHeight;
...
=========
*/
static int pfnSPR_Width( HSPRITE_ hPic, int frame )
{
	int	sprWidth;
...
=========
*/
static void pfnSPR_Set( HSPRITE_ hPic, int r, int g, int b )
{
...
=============
*/
static void pfnSetCrosshair( HSPRITE_ hspr, wrect_t rc, int r, int g, int b )
{
